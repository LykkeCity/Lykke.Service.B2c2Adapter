...
using Lykke.Job.B2c2Adapter.Settings;
using Lykke.Job.B2c2Adapter.Modules;
using Lykke.Logs;
...
namespace Lykke.Job.B2c2Adapter
{
    [PublicAPI]
    public class Startup
    {
        private const string ApiVersion = "v1";
        private const string ApiName = "B2c2AdapterJob API";
        ...
        public IServiceProvider ConfigureServices(IServiceCollection services)
        {
            try
            {
                ...
                services.AddLykkeLogging(
                    settingsManager.ConnectionString(s => s.B2c2AdapterJob.Db.LogsConnString),
                    "B2c2AdapterJobLog",
                ...
                builder.RegisterModule(new JobModule(appSettings.B2c2AdapterJob, settingsManager.Nested(x => x.B2c2AdapterJob)));
